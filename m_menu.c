...
setup_menu_t gen_settings1[] = { // General Settings screen1
  ...
  {"Sound & Music ( use asetup.exe )", S_SKIP|S_TITLE, m_null, G_X, G_Y2 },

  {"Sound Driver", S_NUM|S_DRIVER1|S_SKIP,m_null,G_X-100,
  G_Y2 + general_sndcard*8 +4, {"disk_icon"}},

  {"Midi Driver" , S_NUM|S_DRIVER2|S_SKIP,m_null,G_X-100,
  G_Y2 + general_muscard*8 +4, {"disk_icon"}},
